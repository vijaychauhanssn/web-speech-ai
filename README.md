...
View the demo on [](https://simpleaichatbotdemobyvijay.herokuapp.com/)

This is how this web app works:

1. Using the Web Speech API’s `SpeechRecognition` interface to listen your voice from a microphone
2. Send your message to [API.ai](https://console.dialogflow.com/api-client/) (the natural language processing platform) as a text string
...
[![Deploy](https://simpleaichatbotdemobyvijay.herokuapp.com/)
